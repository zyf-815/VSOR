...
def main(args):
    ...
    #model_root_dir = "./Rank_Saliency/Models/Saliency-Ranking-main(2)"
    #model_names = ['model_final.pth']
    ...
    # model_root_dir = "./Rank_Saliency/Models/RVSOR(53)"
    # model_names = ['model_0019999.pth']
    # model_root_dir = "./Rank_Saliency/Models/RVSOR(4)"
    # model_names = ['model_0009999.pth']

    # model_root_dir = "./Rank_Saliency/Models/RVSOR(3)"
    ...
    # model_root_dir = "./Rank_Saliency/Models/RVSOR(43)"
    # model_names = ['model_0169999.pth']
    #0.762
    # model_names = ['model_0009999.pth', 'model_0019999.pth', 'model_0029999.pth', 'model_0039999.pth',
    #                'model_0049999.pth', 'model_0059999.pth', 'model_0069999.pth', 'model_0079999.pth',
    #                'model_0089999.pth', 'model_0099999.pth', 'model_0109999.pth', 'model_0119999.pth']
